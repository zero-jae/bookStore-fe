...
const DEFALUT_THEME_NAME = "light";
...
export const state = {
  themeName: DEFALUT_THEME_NAME as ThemeName,
  toggleTheme: () => {}
};
...
export const BookStoreThemeProvider = ({children}: {
  children: ReactNode}) => {
    const [themeName, setThemeName] = useState<ThemeName>(DEFALUT_THEME_NAME);
    ...
    useEffect(() => {
      const savedThemeName = localStorage.getItem(
        ...
        setThemeName(savedThemeName || DEFALUT_THEME_NAME);
    }, []);
